...
Retrieve pending contradiction candidates flagged by the heuristic classifier during ingest. HEBBS has no LLM -- the calling agent reviews candidates and commits verdicts.
